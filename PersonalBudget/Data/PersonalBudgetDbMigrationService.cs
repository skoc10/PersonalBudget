...
public class PersonalBudgetDbMigrationService : ITransientDependency
{
    public ILogger<PersonalBudgetDbMigrationService> Logger { get; set; }
    ...
    public async Task MigrateAsync()
    {
        ...
        if (PersonalBudgetModule.IsMultiTenant)
        {
